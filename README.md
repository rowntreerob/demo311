...
[intro to upload](https://colab.research.google.com/github/rowntreerob/demo311/blob/master/photoUpld.ipynb) run notebook, observing functions to get Address from metadata and to classify the photo with AI 
